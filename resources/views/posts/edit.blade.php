	...
	<div class="container pt-2"> 
		<div class="col-7 d-block mx-auto">
			<div class="form-post post p-2 position-relative">
				<form action="/posts/{{ $post->id }}" method="post" class="m-1 h-auto d-flex flex-column">
					@method('put')
					@csrf
					<textarea type="text" class="form-control fs-7 lh-1" name="body" id="body" placeholder="Apa kelusahanmu hari ini?">{{ $post->body }}</textarea>
